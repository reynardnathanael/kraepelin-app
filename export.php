<?php
    ...
    $excel->getActiveSheet()
            ...
            ->setCellValue('A2', 'NAMA : '.$nama.', TANGGAL : '.$tgl);
    ...
    $letter = 'A';
    $letterjawaban = 'B';
    $sql = "SELECT * FROM kraepelin WHERE nkolom <= 20 AND cemail = '$email' AND cnama = '$nama' ORDER BY nkolom asc";
    ...
    /*Rename sheet*/
    $excel->getActiveSheet()->setTitle('Kraeplin(1)');
    ...
    /*Rename sheet*/
    $excel->getActiveSheet()->setTitle('Kraeplin(2)');
